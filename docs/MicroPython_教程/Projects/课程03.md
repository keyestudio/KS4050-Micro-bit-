...
⑤ 读取太阳光紫外线传感器检测到的紫外线强度等级，并且在OLED显示屏的对应位置显示紫外线强度等级。
...
当检测到的太阳紫外线强度级别大于等于3时，Microbit主板上的5×5LED点阵显示图案![Img](./media/ab1.png) 和![Img](./media/ab2.png)，同时扬声器发出警报声；否则，Microbit主板上的5×5LED点阵显示图案![Img](./media/ab3.png)，同时扬声器不发声。
...
OLED显示屏上会实时显示太阳光紫外线传感器检测到的太阳紫外线强度级别，当检测到的太阳紫外线强度级别大于等于5时，Microbit主板上的5×5LED点阵显示图案![Img](./media/ab1.png) 和![Img](./media/ab2.png)，同时扬声器发出警报声，起到警示提醒作用；否则，Microbit主板上的5×5LED点阵显示图案![Img](./media/ab3.png)，同时扬声器不发声。
