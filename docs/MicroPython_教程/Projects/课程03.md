...
| 太阳光紫外线传感器 ×1 |micro USB 线 ×1|4 pin 线材(黑红蓝绿) ×1 |
...
OLED显示屏上会实时显示太阳光紫外线传感器检测到的太阳光紫外线强度，当检测到的太阳光紫外线强度大于等于5时，Microbit主板上的5×5LED点阵屏显示图案![Img](./media/ab1.png) 和![Img](./media/ab2.png)，同时扬声器发出警报声，起到警示提醒作用；否则，Microbit主板上的5×5LED点阵屏显示图案![Img](./media/ab3.png)，同时扬声器不发声。
