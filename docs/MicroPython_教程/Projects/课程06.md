...
⑨ 这是if()...elif()...elif()...elif()...else...的判断语句。
...
OLED显示屏上会实时显示水滴传感器检测到的雨水量强度，当检测到的雨水量强度大于等于10%小于20%时，Microbit主板上的5×5LED点阵屏显示图案![Img](./media/ab7.png)，同时Microbit主板上的扬声器发出C3低音警报声；
