...
⚠️ **特别注意：下面示例代码中，if...elif判断语句中的阈值是可以根据实际情况加以修改的**
...
如果检测到的雨水量百分数值大于等于10小于20时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab7.png)，同时Microbit主板上的扬声器发出C3低音警报声。
...
否则如果检测到的雨水量百分数值大于等于20小于40时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab8.png)，同时Microbit主板上的扬声器发出C4中音警报声。
...
否则如果检测到的雨水量百分数值大于等于40小于60时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab9.png)，同时Microbit主板上的扬声器发出C5高音警报声。
...
否则如果检测到的雨水量百分数值大于等于60时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab10.png)，同时Microbit主板上的扬声器发出B5高音警报声。
...
OLED显示屏上会实时显示水滴传感器检测到的雨水量百分数，当检测到的雨水量百分数值大于等于10小于20时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab7.png)，同时Microbit主板上的扬声器发出C3低音警报声；

当检测到的雨水量百分数值大于等于20小于40时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab8.png)，同时Microbit主板上的扬声器发出C4中音警报声。

当检测到的雨水量百分数值大于等于40小于60时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab9.png)，同时Microbit主板上的扬声器发出C5高音警报声；

当检测到的雨水量百分数值大于等于60时，Microbit主板上的5*5LED点阵显示图案![Img](./media/ab10.png)，同时Microbit主板上的扬声器发出B5高音警报声。

当检测到的雨水量百分数值小于10时，Microbit主板上的5*5LED点阵不显示任何图案，扬声器也不发声。
